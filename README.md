...
- **the Globe** — the satellite-view project explorer at
  [gainforest.app](https://gainforest.app) (source: [GainForest/green_globe](https://github.com/GainForest/green_globe))
- **Bumicerts** — the verifiable-impact funding marketplace at
  [alpha.fund.gainforest.app](https://alpha.fund.gainforest.app) (source:
...
| `NEXT_PUBLIC_BUMICERTS_URL` | no | `https://alpha.fund.gainforest.app` | Where "Explore Bumicerts" / row links go |
| `NEXT_PUBLIC_GREEN_GLOBE_URL` | no | `https://gainforest.app` | Where to fetch project pins from |
