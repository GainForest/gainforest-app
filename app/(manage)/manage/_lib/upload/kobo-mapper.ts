...
const KOBO_PATTERNS: KoboPattern[] = [
  ...
  { pattern: "root_collar_diameter", targetField: "diameter" },
  { pattern: "root_collar_diameter_cm", targetField: "diameter" },
  { pattern: "rootcollardiameter", targetField: "diameter" },
  { pattern: "rootcollardiametercm", targetField: "diameter" },
  { pattern: "rcd", targetField: "diameter" },
  { pattern: "basal_diameter", targetField: "diameter" },
  { pattern: "base_diameter", targetField: "diameter" },
