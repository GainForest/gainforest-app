    ...
    <div className={cn("flex flex-col", className)}>
      ...
      <div className="relative">
        {isEmpty && placeholder ? (
          <p
            aria-hidden
            className="pointer-events-none absolute start-3 top-2 text-base text-muted-foreground md:text-sm"
          >
            {placeholder}
          </p>
        ) : null}
        <div
          ...
          className={cn(
            ...
            "[&_blockquote]:my-1.5 [&_blockquote]:border-s-2 [&_blockquote]:border-primary/40 [&_blockquote]:ps-3 [&_blockquote]:italic [&_blockquote]:text-foreground/70",
            "[&_ul]:my-1.5 [&_ul]:list-disc [&_ul]:ps-5 [&_ol]:my-1.5 [&_ol]:list-decimal [&_ol]:ps-5 [&_li]:my-0.5",
