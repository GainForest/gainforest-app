...
//
// These live in their own (non-client) module so both the real folder grid and
// its loading placeholder can render them: the art is pure decoration with no
// data behind it, so painting it during loading means the tiles never pop.
