...
export const getAccountRouteData = cache(async (
  ...
  const summary = {
    ...baseSummary,
    displayName: baseSummary.displayName ?? directCertifiedProfile?.displayName ?? appViewProfile?.displayName ?? null,
    avatarUrl: baseSummary.avatarUrl ?? directCertifiedProfile?.avatarUrl ?? appViewProfile?.avatar ?? null,
    bio: baseSummary.bio ?? directCertifiedProfile?.description ?? appViewProfile?.description ?? null,
