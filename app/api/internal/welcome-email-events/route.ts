...
const signupWelcomeEventSchema = baseWelcomeEventSchema.extend({
  type: z.literal("user.signup.completed"),
});

const membershipWelcomeEventSchema = baseWelcomeEventSchema.extend({
...
const welcomeEventSchema = z.discriminatedUnion("type", [
  signupWelcomeEventSchema,
  membershipWelcomeEventSchema,
]);
