...
export const CORE_TEAM: ReadonlyArray<Translated<TeamMember>> = [
  {
    ...
    role: "Community Lead",
    location: "Malaysia",
    bio: "Holds GainForest's global community programme together. Spends weeks each year in the field with GainForest's community partners across the network.",
    photo: "/team/nurfatin-hamzah.webp",
    i18n: {
      es: {
        role: "Responsable de Comunidad",
        location: "Malasia",
        bio: "Mantiene el programa comunitario global de GainForest. Pasa varias semanas al año en el campo con socios comunitarios de GainForest en toda la red.",
      },
      pt: {
        role: "Líder de Comunidade",
        location: "Malásia",
        bio: "Mantém o programa comunitário global da GainForest unido. Passa semanas a cada ano em campo com parceiros comunitários da GainForest em toda a rede.",
      },
      sw: {
        role: "Kiongozi wa Jamii",
        location: "Malesia",
        bio: "Anashikilia mpango wa kimataifa wa jamii wa GainForest. Hutumia wiki kadhaa kila mwaka nyanjani na washirika wa jamii wa GainForest kote katika mtandao.",
      },
      id: {
        role: "Pemimpin Komunitas",
        location: "Malaysia",
        bio: "Menyatukan program komunitas global GainForest. Menghabiskan beberapa minggu setiap tahun di lapangan bersama mitra komunitas GainForest di seluruh jaringan.",
      },
    },
  },
  {
    ...
    role: "Engineering & AI",
    location: "Mexico",
    bio: "Builds the open-source GainForest stack and the AI tooling on top of it. Ships ATProto integrations, Cert pipelines, and the models behind them.",
    photo: "/team/diego-rivera-buendia.webp",
    i18n: {
      es: {
        role: "Ingeniería e IA",
        location: "México",
        bio: "Construye el stack open-source de GainForest y las herramientas de IA encima. Entrega integraciones de ATProto, pipelines de Certs y los modelos detrás.",
      },
      pt: {
        role: "Engenharia e IA",
        location: "México",
        bio: "Constrói a stack open-source da GainForest e as ferramentas de IA em cima. Entrega integrações ATProto, pipelines de Certs e os modelos por trás deles.",
      },
      sw: {
        role: "Uhandisi na AI",
        location: "Mexico",
        bio: "Anajenga stack ya open-source ya GainForest na zana za AI juu yake. Hutoa ujumuishaji wa ATProto, mabomba ya Certs, na mifano nyuma yake.",
      },
      id: {
        role: "Teknik & AI",
        location: "Meksiko",
        bio: "Membangun stack open-source GainForest dan perangkat AI di atasnya. Mengirimkan integrasi ATProto, pipeline Certs, dan model di baliknya.",
      },
    },
  },
  {
    ...
    location: "India",
    bio: "Engineer and designer on the GainForest app. Shapes the product, the interface, and the editorial system that make proof-of-impact records feel inviting.",
    photo: "/team/satyam-mishra.webp",
    i18n: {
      es: {
        role: "Ingeniería y Diseño",
        location: "India",
        bio: "Ingeniero y diseñador en la app de GainForest. Da forma al producto, la interfaz y el sistema editorial que hacen que los registros de prueba de impacto se sientan atractivos.",
      },
      pt: {
        role: "Engenharia e Design",
        location: "Índia",
        bio: "Engenheiro e designer na app da GainForest. Molda o produto, a interface e o sistema editorial que tornam os registos de prova de impacto convidativos.",
      },
      sw: {
        role: "Uhandisi na Ubunifu",
        location: "India",
        bio: "Mhandisi na mbunifu kwenye programu ya GainForest. Anatengeneza bidhaa, kiolesura, na mfumo wa uhariri unaofanya rekodi za uthibitisho wa athari zionekane za kuvutia.",
      },
      id: {
        role: "Teknik & Desain",
        location: "India",
        bio: "Insinyur dan desainer aplikasi GainForest. Membentuk produk, antarmuka, dan sistem editorial yang membuat rekam bukti dampak terasa mengundang.",
      },
    },
  },
  {
    ...
    location: "Bhutan",
    bio: "Engineer on the ATProto and Hypercerts layer that anchors every Cert. Contributes across GainForest and the wider Hypersphere ecosystem.",
    photo: "/team/karma-yoezer.webp",
    i18n: {
      es: {
        role: "Ingeniería e Infraestructura",
        location: "Bután",
        bio: "Ingeniero de la capa de ATProto y Hypercerts que ancla cada Cert. Contribuye en GainForest y en el ecosistema más amplio de Hypersphere.",
      },
      pt: {
        role: "Engenharia e Infraestrutura",
        location: "Butão",
        bio: "Engenheiro da camada ATProto e Hypercerts que ancora cada Cert. Contribui em toda a GainForest e no ecossistema Hypersphere mais amplo.",
      },
      sw: {
        role: "Uhandisi na Miundombinu",
        location: "Bhutan",
        bio: "Mhandisi wa safu ya ATProto na Hypercerts inayoshikilia kila Cert. Anachangia katika GainForest na mfumo mpana wa Hypersphere.",
      },
      id: {
        role: "Teknik & Infra",
        location: "Bhutan",
        bio: "Insinyur lapisan ATProto dan Hypercerts yang menjadi jangkar setiap Cert. Berkontribusi di GainForest dan ekosistem Hypersphere yang lebih luas.",
      },
    },
  },
];
