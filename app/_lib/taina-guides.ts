...
export function buildGuideKnowledge(): string {
  return [
    ...
    "### Create a project",
    "Projects → My Projects → 'Add project' → wizard: name + one-line summary → focus areas → dates (ongoing is fine) → story → people & groups + places → photo → review → Create project.",
    "### Edit a project",
