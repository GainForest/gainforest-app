...
truncate public.notification_outbox;
select * from public.notification_outbox_enqueue('health:queued','signup','{}','health-q',null,'health@example.com','welcome','en','health-q','resend',clock_timestamp());
select * from public.notification_outbox_enqueue('health:waiting','bioblitz_winner','{}','health-w','did:plc:winner',null,'bioblitz-winner',null,null,'resend',clock_timestamp());
